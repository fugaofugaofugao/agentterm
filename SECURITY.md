...
AgentTerm controls interactive terminals. Treat access to an AgentTerm server as access to the underlying user account and shell.

## Recommendations

- Use strong passwords.
- Keep `config.yaml`, server keys, JWT secrets, and remote URLs private.
- Put AgentTerm behind HTTPS or a trusted tunnel/VPN before exposing it outside a LAN.
